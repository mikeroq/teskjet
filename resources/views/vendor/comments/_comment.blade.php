...
@endphp
<div class="block block-themed" id="comment-{{ $comment->getKey() }}">
    <div class="block-header bg-primary-dark">
        <h3 class="block-title">
         {{ $comment->commenter->name ?? $comment->guest_name }} ({{ $comment->commenter->email }}) <small>{{ $comment->created_at->diffForHumans() }}</small>
        </h3>
        <div class="dropdown ml-5" id="comment-dropdown-{{ $comment->getKey() }}">
