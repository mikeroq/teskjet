...
@section('content')
    <x-page-header :title="$customer->name" subtitle="Viewing Customer">
        <nav class="flex-sm-00-auto ml-sm-3">
            <div class="dropdown">
                <button type="button" class="btn btn-primary dropdown-toggle" id="dropdown-align-primary"
...
@endsection
@push('modal')
    <div class="modal right fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="edit_modal"
        aria-hidden="true">
    ...
    <div class="modal right fade" id="add_location_modal" tabindex="-1" role="dialog" aria-labelledby="add_location_modal"
        aria-hidden="true">
                ...
                <div class="modal-content block block-themed">
                    ...
                    <div class="modal-footer modal-footer-fixed">
                        <button type="button" class="btn btn-secondary"
                            onclick="$('#add_location_form').trigger('reset');"><i
                                class="fas fa-redo-alt fa-fw mr-1"></i>Reset</button>
