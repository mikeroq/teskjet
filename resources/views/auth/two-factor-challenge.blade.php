        ...
        <div class="row no-gutters justify-content-center bg-primary-dark-op">
            <div class="hero-static col-sm-8 col-md-6 col-xl-4 d-flex align-items-center p-2 px-sm-0">
                <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                    <div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-white" x-data="{ recovery: false }">
                        ...
                        <form class="form-horizontal" action="{{ route('two-factor.login') }}" method="POST" id="2fa_form">
                            ...
                            <div class="form-group text-center">
                                <button type="button" class="btn btn-alt-info btn-sm"
                                    x-show="! recovery"
                                    x-on:click="
                                        recovery = true;
...
$(document).ready(function() {
        $('#code').pincodeInput({hidedigits:false,inputs:6,inputclass:'form-control-lg form-control-alt',complete:function(value, e, errorElement){
