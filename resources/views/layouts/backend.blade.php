...
<html lang="{{ config('app.locale') }}">
    ...
    <body>
        <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed page-header-glass page-header-dark">
            @if(request()->is('admin*'))
                ...
                <div class="content-header">
                    ...
                    <div>
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn btn-dual dropdown-toggle mr-1" id="dropdown-default-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-plus mr-1"></i>
                                <span class="d-none d-sm-inline-block">Create</span>
                            </button>
                            <div class="dropdown-menu p-2" aria-labelledby="dropdown-default-primary">
                                <a class="dropdown-item" data-toggle="modal" data-target="#customer_create_modal"><i class="fas fa-users mr-1"></i> New Customer</a>
                            </div>
                        </div>
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn btn-dual dropdown-toggle" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{-- <img class="img-avatar img-avatar32" id="user_avatar_top" src="/uploads/avatars/{{ Auth::user()->avatar }}" alt=""> --}}
